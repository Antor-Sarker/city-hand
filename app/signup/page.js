...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col 2xl:justify-center items-center px-4 py-2">
        ...
        <div className="px-8 py-8">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              />
              <FieldInput
                field={authformFields.get("phone")}
            ...
            {/* Address */}
            <FieldInput
              field={authformFields.get("address")}
